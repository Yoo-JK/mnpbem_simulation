...
./master.sh --str-conf ./config/dimer/auag_monomer/str/r0.2/config_str_ag_r0.2.py --sim-conf ./config/dimer/auag_monomer/sim/r0.2/config_sim_auag_r0.2.py --verbose
