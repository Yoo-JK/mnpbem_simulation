...
./master.sh --str-conf ./config/rod_exp/rod_contact/au100cu0/config_str_au90cu10.py --sim-conf ./config/rod_exp/rod_contact/au100cu0/config_sim_au90cu10.py --verbose
