...
args['use_parallel'] = False  # Set to False to disable parallel computing
...
args['simulation_name'] = 'sphere_30nm_sub'
...
args['output_dir'] = os.path.join(Path.home(), 'research/mnpbem/mat2py/sphere/stat')
