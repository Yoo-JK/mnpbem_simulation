...
args['output_dir'] = os.path.join(Path.home(), 'research/mnpbem/sphere_cluster_conv')

# ============================================================================
# SIMULATION SETTINGS
# ============================================================================
args['simulation_name'] = 'wo_sub/6_agg_1nm'
...
# WAVELENGTH
# ============================================================================
args['wavelength_range'] = [400, 1000, 200]  # [start, end, n_points]
